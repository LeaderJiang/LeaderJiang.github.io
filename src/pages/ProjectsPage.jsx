    ...
    <Stack spacing={3}>
      <Card sx={{ borderRadius: 1.5, ...frameSx }}>
        ...
        <CardContent sx={{ p: { xs: 3, md: 4 } }}>
          <Box sx={hudHeaderSx}>
            <Typography sx={hudCodeSx}>MISSION</Typography>
            ...
            <Grid size={{ xs: 12, xl: 7 }}>
              <Card sx={{ height: '100%', borderRadius: 1.25, ...frameSx }}>
                ...
                <CardContent sx={{ p: { xs: 3, md: 4 } }}>
                  <Stack spacing={2.5}>
                    <Box sx={hudHeaderSx}>
                      <Typography sx={hudCodeSx}>CASE-01</Typography>
            ...
            <Grid size={{ xs: 12, xl: 5 }}>
              <Stack spacing={2.5} sx={{ height: '100%' }}>
                {[
                  ...
                  <Card key={code} sx={{ flexGrow: 1, borderRadius: 1.25, ...frameSx }}>
                    <Box className="hud-corner hud-corner-tl" />
                    <Box className="hud-corner hud-corner-br" />
                    <CardContent sx={{ p: 3 }}>
                      <Stack spacing={1.5}>
          ...
          <Grid key={project.title} size={{ xs: 12, md: 6 }}>
            <Card sx={{ height: '100%', borderRadius: 1.25, ...frameSx }}>
              ...
              <CardContent sx={{ p: 3 }}>
                <Stack spacing={1.5}>
                  <Box sx={hudHeaderSx}>
                    <Typography sx={hudCodeSx}>0{index + 2}</Typography>
